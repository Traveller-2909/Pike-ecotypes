...
for (i in 1:length(monthID)) {
    ...
    sras <- stack(sras, ipdw)
}

 plot(Land)

 #example for simple error comparison between prediction & measured
valid <- lm(validation[[2]]$WT ~ validation[[2]]$predicted)
...
#save to RData
save(sras, file = "Data/Spatial/Output/Salinity-IPDW-spawning_season_17-22.RData")
...
writeRaster(smean, "Data/Spatial/Output/Sal-ipdw_mean_17-22", format="GTiff",
            overwrite=T)
writeRaster(ssd, "Data/Spatial/Output/Sal-ipdw_sd_17-22", format="GTiff", overwrite=T)
writeRaster(srange_absolute,"Data/Spatial/Output/Sal-ipdw_range_17-22", format="GTiff", overwrite=T)
writeRaster(smax,"Data/Spatial/Output/Sal-ipdw_max_17-22", format="GTiff", overwrite=T)
...
Pikelist <- read.delim("Data/SIMS-pike_2022_id.txt", sep = ";")
