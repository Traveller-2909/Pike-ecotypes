...
save(tras, meanRast, file = "Data/PDW_Jan2019-21.RData")

load("Data/Olga Salinity interpolation/Data/IPDW_results.RData")


meanRast <- calc(tras, fun = mean)
...
writeRaster(tras, "Data/Temp-test", format="GTiff", overwrite=T)
...
plot(Oclust_F$k_3, type="series", linetype="dotted", cex=1)+
