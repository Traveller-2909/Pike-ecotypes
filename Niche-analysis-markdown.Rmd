...
#save to RData
save(sras, file = "Data/Spatial/Output/Salinity-IPDW-mean-2007-2022_monthly.RData")
...
load("Data/Spatial/IPDW_results.RData")
...
newdata <- data.frame(Sr = seq(0.0007,0.006, 0.0001))
